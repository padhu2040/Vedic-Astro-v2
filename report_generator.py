...
def get_south_indian_chart_html(p_pos, lagna_rasi, title, lang="English"):
    ...
    # STRICT CSS: table-layout: fixed and rigid heights prevent stretching
    td_style = "border: 1px solid #333; width: 25%; height: 105px; max-height: 105px; vertical-align: top; padding: 5px; background-color:#fafafa; overflow: hidden; box-sizing: border-box;"
        
    return f"<div style='max-width: 450px; margin: auto; font-family: sans-serif;'><table style='width: 100%; table-layout: fixed; border-collapse: collapse; text-align: center; font-size: 14px; background-color: #ffffff; border: 2px solid #333;'><tr><td style='{td_style}'><div style='font-size:11px; color:#7f8c8d; text-align:left;'>{get_z(12)} (12)</div>{g[12]}</td><td style='{td_style}'><div style='font-size:11px; color:#7f8c8d; text-align:left;'>{get_z(1)} (1)</div>{g[1]}</td><td style='{td_style}'><div style='font-size:11px; color:#7f8c8d; text-align:left;'>{get_z(2)} (2)</div>{g[2]}</td><td style='{td_style}'><div style='font-size:11px; color:#7f8c8d; text-align:left;'>{get_z(3)} (3)</div>{g[3]}</td></tr><tr><td style='{td_style}'><div style='font-size:11px; color:#7f8c8d; text-align:left;'>{get_z(11)} (11)</div>{g[11]}</td><td colspan='2' rowspan='2' style='border: none; vertical-align: middle; font-weight: bold; font-size: 16px; color:#2c3e50; background-color: #ffffff;'>{title}</td><td style='{td_style}'><div style='font-size:11px; color:#7f8c8d; text-align:left;'>{get_z(4)} (4)</div>{g[4]}</td></tr><tr><td style='{td_style}'><div style='font-size:11px; color:#7f8c8d; text-align:left;'>{get_z(10)} (10)</div>{g[10]}</td><td style='{td_style}'><div style='font-size:11px; color:#7f8c8d; text-align:left;'>{get_z(5)} (5)</div>{g[5]}</td></tr><tr><td style='{td_style}'><div style='font-size:11px; color:#7f8c8d; text-align:left;'>{get_z(9)} (9)</div>{g[9]}</td><td style='{td_style}'><div style='font-size:11px; color:#7f8c8d; text-align:left;'>{get_z(8)} (8)</div>{g[8]}</td><td style='{td_style}'><div style='font-size:11px; color:#7f8c8d; text-align:left;'>{get_z(7)} (7)</div>{g[7]}</td><td style='{td_style}'><div style='font-size:11px; color:#7f8c8d; text-align:left;'>{get_z(6)} (6)</div>{g[6]}</td></tr></table></div>"
